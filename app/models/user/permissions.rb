  ...
  def can_create?(klass)
    ...
    case klass.to_s
      when 'SongEntry'
        ...
        reason = Reason.new "К сожалению, вы временно отключили возможность заливать музыку. Как временное решение, пользуйтесь сервисами, на которые можно залить треки, а потом вставляйте проигрыватель в тейсти. Приносим свои извинения за неудобства."
