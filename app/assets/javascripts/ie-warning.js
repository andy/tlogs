/* this script is courtesy of khanacademy.org */
var msg1 = "Вы знали, что Internet Explorer уже давно устарел?";
var msg2 = "Чтобы пользоваться тейсти, мы рекомендуем вам установить более современный браузер. Весь интернет тогда станет лучше и безопаснее для вас.";
var msg3 = "Нажмите на любую из иконок ниже, чтобы перейти на страницу скачивания браузера.";
var br1 = "Chrome 2.0+";
var br2 = "Firefox 3+";
var br3 = "Safari 3+";
