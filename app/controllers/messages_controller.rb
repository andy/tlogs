class MessagesController < ApplicationController
  ...
  def create
    ...
    @message.save
    Emailer.deliver_message(current_site, @message) if @message.valid? && @message.sender_id != current_site.id && current_site.is_emailable? && current_site.tlog_settings.email_messages?
  end
