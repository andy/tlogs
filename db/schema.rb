...
ActiveRecord::Schema.define(:version => 20111213165134) do
  ...
  create_table "entries", :force => true do |t|
    ...
    t.text     "data_part_2"
    t.text     "data_part_3"
    t.string   "type",             :limit => 32, :default => "TextEntry", :null => false
    t.boolean  "is_disabled",                   :default => false,       :null => false
    t.datetime "created_at",                                             :null => false
    t.text     "metadata"
  ...
  create_table "entry_ratings", :force => true do |t|
    t.integer  "entry_id",                                                   :default => 0,           :null => false
    t.string   "entry_type",    :limit => 32,                                 :default => "TextEntry", :null => false
    t.datetime "created_at",                                                                          :null => false
    t.integer  "user_id",                                                    :default => 0,           :null => false
